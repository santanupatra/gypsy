...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wishlist__ = __webpack_require__(710);
...
var WishlistPage = /** @class */ (function () {
    ...
    WishlistPage.prototype.mylikelist = function () {
        var _this = this;
        this.api.likelist('my_like_list', { user_id: this.user_id }).subscribe(function (response) {
            console.log(response);
            if (response.ACK === 1) {
                _this.likelist = response.likelist;
                _this.is_exist = 1;
